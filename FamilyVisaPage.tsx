...
const FamilyVisaPage = () => {
  ...
  const countries = [
    { name: 'Canada', flag: '🇨🇦', processing: '12-20 months' },
    { name: 'Australia', flag: '🇦🇺', processing: '9-18 months' },
    { name: 'United Kingdom', flag: '🇬🇧', processing: '2-6 months' },
    { name: 'United States', flag: '🇺🇸', processing: '8-33 months' },
    { name: 'New Zealand', flag: '🇳🇿', processing: '6-12 months' },
    { name: 'Germany', flag: '🇩🇪', processing: '3-6 months' }
  ];
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {countries.map((country, index) => (
              <div key={index} className="bg-white p-6 rounded-xl hover:shadow-lg transition-shadow">
                ...
                <p className="text-gray-600 mb-4">Average Processing: <span className="font-semibold">{country.processing}</span></p>
                <button 
                  onClick={openWhatsApp}
